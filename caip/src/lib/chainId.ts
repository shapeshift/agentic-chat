...
import type { CHAIN_NAMESPACE, CHAIN_REFERENCE } from './constants.js';
...
export type ChainNamespace =
  (typeof CHAIN_NAMESPACE)[keyof typeof CHAIN_NAMESPACE];
export type ChainReference =
  (typeof CHAIN_REFERENCE)[keyof typeof CHAIN_REFERENCE];
