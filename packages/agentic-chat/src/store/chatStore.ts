...
import type { PersistedToolState } from '../types/toolState'

import { createMessageStorage } from './messageStorage'
...
export const createChatStore = (prefix = 'shapeshift-chat', messagesPrefix = 'ai-chat-messages') => {
  const messageStorage = createMessageStorage(messagesPrefix)
    ...
    persist(
      (set, get) => ({
        ...
        deleteConversation: (id: string) => {
          ...
          messageStorage.deleteMessages(id)
        },
