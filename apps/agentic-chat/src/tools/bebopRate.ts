...
export const bebopRateDescription = `
🔍 Bebop Rate Tool

This tool fetches swap quotes from Bebop, a decentralized exchange aggregator.

Input:
- chain: The blockchain network (e.g., ethereum, arbitrum, base)
- fromAsset: The token to sell (address, precision, name, symbol)
- toAsset: The token to buy (address, precision, name, symbol)
- amount: The amount to sell in human-readable format

Output:
- buyAmount: The amount you'll receive (in both base units and human-readable precision)
- buyToken: Details about the token you'll receive
- sellToken: Details about the token you're selling
- originalData: Additional market data including:
  - Price impact
  - Slippage
  - Market data
  - Gas estimates
