    ...
    return (
      <div className="text-muted-foreground text-sm">
        ✅ Quote found • Rate: 1 {result.swapData.sellAsset.symbol} = {(
          parseFloat(result.swapData.buyAmountCryptoPrecision) / 
          parseFloat(result.swapData.sellAmountCryptoPrecision)
        ).toFixed(6)} {result.swapData.buyAsset.symbol}
      </div>
    )
  }
